...
public class PersistenceHelper
    ...
    public void invokeOperationWithWait(String sOperation, String sSnapshot, String sServiceName)
        ...
        try
            ...
            {
            throw Base.ensureRuntimeException(e, "Unable to complete operation " + sOperation +
                                                 " for service " + sServiceName);
            }
        }
    ...
    public static String getMBeanName(String sServiceName)
        {
        return Registry.PERSISTENCE_SNAPSHOT_TYPE + ",service=" + sServiceName + "," + Registry.KEY_RESPONSIBILITY
               + PersistenceManagerMBean.PERSISTENCE_COORDINATOR;
        }
